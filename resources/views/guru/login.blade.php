...
<body>
  <div class="wrapper">
    ...
    <div class="navbar">
      <ul>
        <li><a class="active" href="{{ route('guru.login') }}">Beranda</a></li>
      </ul>
    </div>
    <div class="konten">
        ...
        <div class="kiri-atas">
          <h2>Login Guru</h2>
            <div class="menu-login" align="center">
              ...
              <a class="button-login active" href="{{ route('guru.login') }}">Guru</a>
              <a class="button-login" href="{{ route('siswa.login') }}">Siswa</a>
            </div>
          <table name="form-login" align="center">
            <form action="{{ route('guru.aksi.login') }}" method="post">
              @csrf

              <tr>
                <td><label>NIP</label></td>
                <td><input type="text" name="nip" autocomplete="no"></td>
              </tr>
              <tr>
