...
<body>
  <div class="wrapper">
    ...
    <div class="navbar">
      <ul>
        <li style="margin-right: 5px;"><a class="active" href="{{ route('siswa.home') }}">Beranda</a></li>
        <li style="margin-right: 5px;"><a href="{{ route('siswa.nilai') }}">Nilai</a></li>
