...
<body>
  <div class="wrapper">
    ...
    <div class="navbar">
      <ul>
        <li><a class="active" href="{{ route('admin.login') }}">Beranda</a></li>
      </ul>
    </div>
    <div class="konten">
        ...
        <div class="kiri-atas">
          <h2>Login Admin</h2>
            <div class="menu-login" align="center">
              <a class="button-login active" href="{{ route('admin.login') }}">Admin</a>
              <a class="button-login" href="{{ route('guru.login') }}">Guru</a>
              <a class="button-login" href="{{ route('siswa.login') }}">Siswa</a>
            </div>
          <table name="form-login" align="center">
            <form action="{{ route('admin.aksi.login') }}" method="post">
              @csrf

              <tr>
                <td><label>Username</label></td>
                <td><input type="text" name="username" autocomplete="no"></td>
              </tr>
              <tr>
